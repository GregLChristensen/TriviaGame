...
$( document ).ready(function() {
    ...
    // this game object holds all of the questions, possible answers, and then the index of the correct answers
        var game = {
            questions: [
            {
                question: 'In the year 1900 in the U.S. what were the most popular first names given to boy and girl babies?',
                possibles: ['William and Elizabeth', 'Joseqph and Catherine', 'John and Mary', 'George and Anne'],
                id: 'question-one',
                answer: 2
            }, {
